  ...
  return (
    <main className="ops-shell">
      ...
      <header className="topbar">
        <div className="brand-lockup"><div className="brand-mark">↗</div><div><p className="eyebrow">RAILWAY OPERATIONS</p><p className="brand-name">NEXUS / ETA</p></div></div>
